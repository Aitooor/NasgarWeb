...
async function printPDF(order) {
  const browser = await puppeteer.launch({ headless: true });
  const page = await browser.newPage();
  await page.goto('https://nasgar.online/public/orders/' + order, { waitUntil: 'networkidle0' });
